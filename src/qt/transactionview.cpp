...
void TransactionView::changedAmount(const QString &amount)
{
    ...
    // Replace "," by "." so WayaWolfCoinUnits::parse will not fail for users entering "," as decimal separator
    QString newAmount = amount;
    newAmount.replace(QString(","), QString("."));

    if(WayaWolfCoinUnits::parse(model->getOptionsModel()->getDisplayUnit(), newAmount, &amount_parsed))
    {
...
void TransactionView::exportClicked()
{
    ...
    writer.addColumn(WayaWolfCoinUnits::getAmountColumnTitle(model->getOptionsModel()->getDisplayUnit()), 0, TransactionTableModel::FormattedAmountRole);
...
void TransactionView::computeSum()
{
    ...
    QString strAmount(WayaWolfCoinUnits::formatWithUnit(nDisplayUnit, amount, true, WayaWolfCoinUnits::separatorAlways));
