...
class QCP_LIB_DECL QCPAxis : public QCPLayerable
{
  ...
  Q_PROPERTY(bool rangeWayaWolfCoinersed READ rangeWayaWolfCoinersed WRITE setRangeWayaWolfCoinersed)
...
public:
  ...
  */
  ...
  bool rangeWayaWolfCoinersed() const { return mRangeWayaWolfCoinersed; }
  ...
  void setRangeWayaWolfCoinersed(bool reversed);
