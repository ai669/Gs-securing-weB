 ...
 * The WayaWolfCoin Developers 2018-2020
 */
    ...
    nWeight(0)
{
    ...
    setWindowTitle(tr("WayaWolfCoin") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    ...
    setObjectName("WayaWolfCoin");
    setStyleSheet("#WayaWolfCoin { background-image: url(:/images/background_light); }");//background-color: #e6e6e6; color: #333333;
...
void WayaWolfCoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(fUseDarkTheme ? ":/icons/dark/bitcoin-dark" : ":/icons/bitcoin"), tr("&About WayaWolfCoin"), this);
    ...
    editConfigAction = new QAction(QIcon(":/icons/editconf"), tr("&Edit WayaWolfCoin.conf"), this);
    editConfigAction->setToolTip(tr("Edit the configuration file for WayaWolfCoin"));
    editConfigExtAction = new QAction(QIcon(":/icons/editconf"), tr("&Edit WayaWolfCoin.conf (external)"), this);
    editConfigExtAction->setToolTip(tr("Edit the configuration file for WayaWolfCoin (external editor)"));
    openDataDirAction = new QAction(QIcon(":/icons/folder"), tr("&Open data dir"), this);
    openDataDirAction->setToolTip(tr("Open the directory where WayaWolfCoin data is stored"));
...
void WayaWolfCoinGUI::setMessageModel(MessageModel *messageModel)
{
...
void WayaWolfCoinGUI::aboutQtExt_Internal()
{
    aboutQtAction->triggered();
}

void WayaWolfCoinGUI::aboutQtExt_Static()
{
...
void WayaWolfCoinGUI::error(const QString &title, const QString &message, bool modal)
{
...
void WayaWolfCoinGUI::incomingMessage(const QModelIndex & parent, int start, int end)
{
    if(!messageModel)
        return;
...
void WayaWolfCoinGUI::clearWidgets()
{
...
void WayaWolfCoinGUI::gotoBlockBrowser()
{
    ...
    setStyleSheet("#WayaWolfCoin { background-image: url(:/images/background_light_alt); }");
}
...
void WayaWolfCoinGUI::gotoOverviewPage()
{
    ...
    setStyleSheet("#WayaWolfCoin { background-image: url(:/images/background_light); }");
}
...
void WayaWolfCoinGUI::gotoHistoryPage_static()
{
...
void WayaWolfCoinGUI::gotoMessagePage()
{
...
void WayaWolfCoinGUI::gotoSettingsPage()
{
...
void WayaWolfCoinGUI::setWalletUnlockStakingOnly()
{
...
void WayaWolfCoinGUI::setUnencrypted()
{
    changePassphraseAction->setEnabled(false);
...
void WayaWolfCoinGUI::setUnlocked()
{
...
void WayaWolfCoinGUI::setLocked()
{
    changePassphraseAction->setEnabled(true);
    unlockWalletAction->setVisible(true);
    lockWalletAction->setVisible(false);
...
void WayaWolfCoinGUI::importPrivateKey()
{
...
/*void WayaWolfCoinGUI::showProgress(const QString &title, int nProgress)
{
    if (nProgress == 0)
    {
...
void WayaWolfCoinGUI::editConfig()
{
...
void WayaWolfCoinGUI::editConfigExt()
{
...
void WayaWolfCoinGUI::openDataDir()
{
