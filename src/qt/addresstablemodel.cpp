...
bool AddressTableModel::setData(const QModelIndex &index, const QVariant &value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case Label:
            ...
            {
                wallet->SetAddressBookName(CWayaWolfCoinAddress(strTemp).Get(), value.toString().toStdString());
            }
            break;
        case Address:
...
{
    // Update address book model from WayaWolfCoin core
...
{
    {
        ...
        {
            CWayaWolfCoinAddress address_parsed(sAddr);
