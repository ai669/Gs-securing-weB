...
public:
    ...
    */
    ...
    /** Set the message model.
        The message model represents a WayaWolfCoin  Note or D-Note, and offers secure messaging through a peer to peer
        relay.
    */
...
private slots:
    ...
    */
    ...
    /** Edit the WayaWolfCoin.conf file */
    void editConfig();
    void editConfigExt();
